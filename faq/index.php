...
$contentContainer = array(
    array(
        ...
        <div>
            <p>Apologies for the inconvenience caused. In rare occasions an item might not work or may get damaged during transport. If such is the case, our aim is to solve the problem as quickly as possible. Please note that in such a case you are obliged to notify our team to <a href="mailto:support@coincod.com">support@coincod.com</a> within 3 days after delivery. It can sometimes be useful to check the manufacturer\'s website or call their helpline - many of the most common problems are easily solved without having to return the product. In the event that the product you received is faulty, please contact us at <a href="mailto:support@coincod.com">support@coincod.com</a> and we\'ll tell you what to do next. Please let us know the Product ID and the serial number of the product, as these help us to deal with your problem as quickly as possible. We work with a range of different suppliers who are happy to help identify any problems and to replace faulty items if necessary.</p>
            <p>NOTE:Please don\'t send the item back to us without contacting us - this could result in a delay between return of your item and a replacement being dispatched. If your product does need replacing, we\'ll contact you and let you know when that will be done.</p>
        </div>
